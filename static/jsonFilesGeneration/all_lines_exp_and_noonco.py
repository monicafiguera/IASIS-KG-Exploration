...
drugLineFiles = [
    ...
    './data/patient_drug_by_treatment_line_v2/patient-drug_line2.csv',
    './data/patient_drug_by_treatment_line_v2/patient-drug_line3.csv',
    './data/patient_drug_by_treatment_line_v2/patient-drug_line4.csv',
    './data/patient_drug_by_treatment_line_v2/patient-drug_line5.csv',
    './data/patient_drug_by_treatment_line_v2/patient-drug_line6.csv',
    './data/patient_drug_by_treatment_line_v2/patient-drug_line7.csv',
    './data/patient_drug_by_treatment_line_v2/patient-drug_line8.csv',
    './data/patient_drug_by_treatment_line_v2/patient-drug_line10.csv'
]

nonOncoFile = './data/nonOncologycalTreatments.csv'
...
for file in drugLineFiles:
    ...
    filesToAnalyze.append(nonOncoFile);
    for f in filesToAnalyze:
    ...
    open(dirname + "/line" + str(index) + "_all_exp_and_noonco.json", "w", encoding="utf8").write(json_data)
