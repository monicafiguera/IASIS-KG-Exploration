...
drugLineFiles = [
    './data/exp_by_treatment_type/ant/patient-ant_line1.csv',
    './data/exp_by_treatment_type/ant/patient-ant_line2.csv',
    './data/exp_by_treatment_type/ant/patient-ant_line3.csv',
    './data/exp_by_treatment_type/ant/patient-ant_line4.csv',
    './data/exp_by_treatment_type/ant/patient-ant_line5.csv',
    './data/exp_by_treatment_type/ant/patient-ant_line8.csv'
]
...
for file in drugLineFiles:
    ...
    subStrFile = "patient-ant_line"
    subStrFileIndex = file.index(subStrFile)
    index = file[subStrFileIndex + len(subStrFile): -4]

    dirname = "./jsons_ant/json_line" + str(index)
    if not os.path.exists(dirname):
        os.mkdir(dirname)

    open(dirname + "/line" + str(index) + "_ant_exp_and_noonco.json", "w", encoding="utf8").write(json_data)
