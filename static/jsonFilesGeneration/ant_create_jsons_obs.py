...
drugLineFiles = [
    './data/obs_by_treatment_type/ant/ant_treatment_line1.csv',
    './data/obs_by_treatment_type/ant/ant_treatment_line2.csv',
    './data/obs_by_treatment_type/ant/ant_treatment_line3.csv',
    './data/obs_by_treatment_type/ant/ant_treatment_line4.csv',
    './data/obs_by_treatment_type/ant/ant_treatment_line5.csv',
    './data/obs_by_treatment_type/ant/ant_treatment_line8.csv'
]
...
for file in drugLineFiles:
    ...
    open(dirname + "/line" + str(index) + "_ant_obs.json", "w", encoding="utf8").write(json_data)
