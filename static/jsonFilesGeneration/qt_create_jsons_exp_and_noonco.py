...
drugLineFiles = [
    './data/exp_by_treatment_type/qt/patient-qt_line1.csv',
    './data/exp_by_treatment_type/qt/patient-qt_line2.csv',
    './data/exp_by_treatment_type/qt/patient-qt_line3.csv',
    './data/exp_by_treatment_type/qt/patient-qt_line4.csv',
    './data/exp_by_treatment_type/qt/patient-qt_line5.csv',
    './data/exp_by_treatment_type/qt/patient-qt_line6.csv',
    './data/exp_by_treatment_type/qt/patient-qt_line7.csv',
    './data/exp_by_treatment_type/qt/patient-qt_line8.csv',
    './data/exp_by_treatment_type/qt/patient-qt_line10.csv'
]
...
for file in drugLineFiles:
    ...
    open(dirname + "/line" + str(index) + "_qt_exp_and_noonco.json", "w", encoding="utf8").write(json_data)
