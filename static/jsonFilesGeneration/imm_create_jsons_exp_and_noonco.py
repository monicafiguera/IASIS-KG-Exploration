...
drugLineFiles = [
    './data/exp_by_treatment_type/imm/patient-imm_line1.csv',
    './data/exp_by_treatment_type/imm/patient-imm_line2.csv',
    './data/exp_by_treatment_type/imm/patient-imm_line3.csv',
    './data/exp_by_treatment_type/imm/patient-imm_line4.csv',
    './data/exp_by_treatment_type/imm/patient-imm_line5.csv',
    './data/exp_by_treatment_type/imm/patient-imm_line6.csv',
    './data/exp_by_treatment_type/imm/patient-imm_line7.csv',
    './data/exp_by_treatment_type/imm/patient-imm_line8.csv'
]
...
for file in drugLineFiles:
    ...
    subStrFile = "patient-imm_line"
    subStrFileIndex = file.index(subStrFile)
    index = file[subStrFileIndex + len(subStrFile): -4]

    dirname = "./jsons_imm/json_line" + str(index)
    if not os.path.exists(dirname):
        os.mkdir(dirname)

    open(dirname + "/line" + str(index) + "_imm_exp_and_noonco.json", "w", encoding="utf8").write(json_data)
